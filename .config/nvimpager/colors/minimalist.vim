...
hi Folded           ctermfg=242     ctermbg=234     cterm=NONE      guifg=#666666       guibg=NONE     gui=NONE
hi IncSearch        ctermfg=234     ctermbg=75      cterm=NONE      guifg=#1C1C1C       guibg=#5FAFFF   gui=NONE
hi LineNr           ctermfg=59      ctermbg=234     cterm=NONE      guifg=#5F5F5F       guibg=NONE     gui=NONE
...
hi Whitespace       ctermfg=59      ctermbg=234     cterm=NONE      guifg=#5F5F5F       guibg=NONE     gui=NONE
hi NonText          ctermfg=59      ctermbg=234     cterm=NONE      guifg=#5F5F5F       guibg=NONE     gui=NONE
hi Normal           ctermfg=255     ctermbg=234     cterm=NONE      guifg=#EEEEEE       guibg=NONE     gui=NONE
...
hi SpecialKey       ctermfg=59      ctermbg=234     cterm=NONE      guifg=#5F5F5F       guibg=#3A3A3A   gui=NONE
...
hi Todo             ctermfg=74      ctermbg=234     cterm=inverse   guifg=#5FAFD7       guibg=NONE     gui=inverse,bold
